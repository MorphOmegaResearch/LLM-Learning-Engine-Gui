...
try:
    ...
    print("WARNING: 'requests' module not found. Model inference and some evaluation features will be disabled.")
...
class EvaluationEngine:
    ...
    def _get_model_response(self, model_name: str, prompt: str,
        ...
        if not REQUESTS_AVAILABLE:
            return {"error": "Model inference disabled: 'requests' module not available."}
