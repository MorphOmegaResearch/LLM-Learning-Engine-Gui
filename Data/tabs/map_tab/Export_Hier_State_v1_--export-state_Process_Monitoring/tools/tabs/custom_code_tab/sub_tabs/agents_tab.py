...
# Phase Sub-Zero-D: optional debug logger / decorator
try:
    from debug_logger import get_logger as get_debug_logger, debug_ui_event
except ImportError:  # Fallback when debug harness not available
...
class AgentsTab(ttk.Frame):
    ...
    _agents_tab_debug_logger = get_debug_logger("agents_tab")
    ...
    @debug_ui_event(_agents_tab_debug_logger)
