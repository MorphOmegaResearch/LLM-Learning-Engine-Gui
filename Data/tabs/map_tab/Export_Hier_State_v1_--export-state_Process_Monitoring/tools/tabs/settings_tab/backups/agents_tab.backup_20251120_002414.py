...
class AgentsTab(ttk.Frame):
    ...
    _agents_tab.backup_20251120_002414_debug_logger = get_debug_logger("agents_tab.backup_20251120_002414")
    ...
    @debug_ui_event(_agents_tab.backup_20251120_002414_debug_logger)
