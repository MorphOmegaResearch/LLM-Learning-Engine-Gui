...
from config import get_category_info, create_category_folder, create_subcategory_file
...
class DatasetPanel:
    ...
    def get_selected_datasets(self):
        ...
        selected_files = []
        training_data_root = Path(__file__).parent.parent.parent.parent / "Training_Data-Sets"
