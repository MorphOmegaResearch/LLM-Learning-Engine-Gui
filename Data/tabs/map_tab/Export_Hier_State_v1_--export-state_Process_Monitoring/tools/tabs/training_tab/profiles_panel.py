...
class ProfilesPanel:
    ...
    def create_ui(self):
        ...
        try:
            ...
            logger_util.log_message(f"PROFILES_PANEL: Error loading profiles: {e}")
            profile_list = []
    ...
    def load_profile_from_gui(self, event=None):
        ...
        try:
            ...
            try:
                ...
                use_type_schema = bool(eval_prefs.get("use_type_schema", False))
                ...
                if hasattr(self.training_tab_instance, 'type_schema_selected_var'):
                    sel_type_schema = eval_prefs.get("type_schema") or ""
                    self.training_tab_instance.type_schema_selected_var.set(sel_type_schema)
                ...
                if hasattr(self.training_tab_instance, '_update_type_schemas_selected_count'):
                    self.training_tab_instance._update_type_schemas_selected_count()
            except Exception:
                pass
    ...
    def _build_current_settings_profile_dict(self):
        ...
        current_config = {
            ...
            "evaluation_preferences": {
                ...
                "use_type_schema": bool(getattr(self.training_tab_instance, 'type_schema_selected_var', tk.StringVar(value="")).get()) if hasattr(self, 'training_tab_instance') else False,
                "type_schema": getattr(self.training_tab_instance, 'type_schema_selected_var', tk.StringVar(value="")).get() if hasattr(self, 'training_tab_instance') else None,
