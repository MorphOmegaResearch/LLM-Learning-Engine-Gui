...
class ChatInterfaceTab(BaseTab):
    ...
    _chat_interface_tab.backup_20251120_002414_debug_logger = get_debug_logger("chat_interface_tab.backup_20251120_002414")
    ...
    @debug_ui_event(_chat_interface_tab.backup_20251120_002414_debug_logger)
