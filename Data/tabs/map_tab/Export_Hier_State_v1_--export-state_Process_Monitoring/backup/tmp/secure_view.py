...
class SecureViewApp:
    ...
    def show_hier_tooltip(self, item, x, y):
        ...
        # Offset to prevent covering the cursor or menu
        self.tooltip.geometry(f" +{x+20}+{y+10}")
    ...
    def show_context_menu(self, event):
        ...
        if item:
            ...
            # Optionally show hover info immediately when right-clicking
            if event.widget == self.hier_tree:
                self.show_hier_tooltip(item, event.x_root, event.y_root)
